                ...
                <div class="signup-card signup-form-container">
                    ...
                    <form>
                        <div class="s-1 form-input-box">
                            ...
                            <input type="text" class="sform-control" id="password">
                        </div>
                        <div class="s-1 form-input-box">
                        ...
                        <div class="s-1 form-input-box">
                            ...
                            <input type="email" class="sform-control" id="password">
                        </div>
                        <div class="s-1 form-input-box">
                            <label for="name" class="sform-label">Password</label>
                            <input type="password" class="sform-control" id="password">
                        </div>
                        <div class="s-1 form-input-box">
                        ...
                        <div class="s-1 form-input-box">
                            ...
                            <input type="number" class="sform-control" id="password">
                        </div>
                        ...
                        <div class="form-end">
                            <p class="p-1">Already have an account? <a href="../html/login.php">Login</a></a></p>
                        </div>
                    </form>
                </div>
            </div>
