...
<?php 
    ...
    if (isset($_POST['login'])) {
        ...
        $sql_query = "SELECT user_Name FROM users WHERE email='$email' and password='$password'";
        ...
        <div class="card">
            <div class="card-body login-card">
                ...
                <div class="register-container">
                    ...
                    <button type="submit" class="btn btn-primary"><a href="./sign.php"></a>Sign up</button>
                </div>
            </div>
        </div>
    </div>
